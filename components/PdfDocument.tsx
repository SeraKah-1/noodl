...
const PageFooter = () => (
  <View style={s.footer} fixed>
    <Text>Generated by Mikir ( •_•)⌐■-■</Text>
...
export const DeepInsightPdf: React.FC<DeepInsightPdfProps> = ({ data, title }) => {
  ...
  return (
    <Document title={`Peta Pemahaman - ${title}`} author="Mikir App" subject={title}>
      <Page size="A4" style={s.page} wrap>
        ...
        <View style={s.headerBar} fixed>
          ...
          <Text style={s.subtitle}>Topik: {title} • {now} • Generated by Mikir</Text>
        </View>
