...
export const KEYS = {
  ...
  pendingLibraryUploads: 'noodl_pending_library_uploads',
  pendingLibraryDeletions: 'noodl_pending_library_deletions',
  pendingSrsUploads: 'noodl_pending_srs_uploads',
  pendingSrsDeletions: 'noodl_pending_srs_deletions',
  libraryIdb: 'noodl_library_store',
  graveyard: 'noodl_graveyard',
  theme: 'noodl_theme',
  storagePref: 'noodl_storage_pref',
  srsEnabled: 'noodl_srs_enabled',
  wakeLockEnabled: 'noodl_wakelock_enabled',
